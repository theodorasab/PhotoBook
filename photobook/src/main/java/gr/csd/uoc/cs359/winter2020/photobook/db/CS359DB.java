...
public class CS359DB {
    ...
    private static final String UNAME = "csd4178"; // Share your repo to give you the credentials
    private static final String PASSWD = "Lv>wY8F6";  // Share your repo to give you the credentials
